<template>
	<div class="show-box"  :class="{disabled: disabled, active: isShowList}" :style="style_Container" style="width: 360rpx;height: 80rpx;font-size: 28rpx;border-top-right-radius:0;border-bottom-right-radius:0;">
		<!-- 输入框，仅在可输入模式下使用 -->
		<input  
		...
		<div v-else class="input" :class="{placeholder: selectText === placeholder}" @click.stop="onUpperClick" style='justify-content: center;'>
			...
			<span class="iconfont iconarrowBottom-fill right-arrow" :class="{isRotate: isRotate}" style="height: 40rpx;margin-top: 6rpx;margin-left: 24rpx;"></span>
		</div>
...
<style scoped lang="less">
	...
	@hover-color: white;       //边框的颜色
	@active-color: #409eff;       //活动的颜色
	@mouse-move-color: #f5f7fa;  //在列表项上按下时的列表项的背景色
	@padding-left: 0%;           //两侧的边距
	@arrowWidth: 0%;            //右边的小三角按钮区域的宽度
	...
	.show-box{
		...
		.right-arrow{
			...
			transition: transform .2s cubic-bezier(.645,.045,.355,1);
			 ...
			 // position: absolute;
			top: 0;
			align-items: center; color: #bbb; height: 100%;
